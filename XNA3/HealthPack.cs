...
namespace XNA3
{
    ...
    /// </summary>
    public class HealthPack : Microsoft.Xna.Framework.DrawableGameComponent
    {
        protected Texture2D healthTex;
        ...
        public HealthPack(Game game, ref Texture2D theTexture)
            : base(game)
        {
            healthTex = theTexture;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            sBatch.Draw(healthTex, position, spriteRectangle, Color.White);
            base.Draw(gameTime);
        }
